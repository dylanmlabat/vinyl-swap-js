...
album6 = Album.create(artist: 'Joanna Newsome', title: 'Ys', release_year: '2006', genre: 'Folk')
album7 = Album.create(artist: 'Charles Mingus', title: 'The Black Saint and the Sinner Lady', release_year: '1963', genre: 'Jazz')
album8 = Album.create(artist: 'Bill Evans Trio', title: 'Waltz for Debby', release_year: '1962', genre: 'Jazz')
