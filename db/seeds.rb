...
listing9 = Listing.create(condition: 'Very Good', price: 12, notes: ["Sealed"], user_id: 4, album_id: 1)
listing10 = Listing.create(condition: 'Poor', price: 6, notes: nil, user_id: 5, album_id: 8)
